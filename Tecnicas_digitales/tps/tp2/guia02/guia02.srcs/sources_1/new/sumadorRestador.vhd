...
--Guarda la operacion de suma-resta
...
begin
  ...
  --Habrá overflow si: 
    --la suma de dos números positivos (MSB = 0) da negativo (MSB = 1).  
    --la suma de dos números negativos (MSB = 1) da positivo (MSB = 0).
    --la resta de un número positivo (MSB = 0) y uno negativo (MSB = 1) da negativo (MSB = 1)
    --la resta de un número negativo (MSB = 1) y uno positivo (MSB = 0) da positvo (MSB = 0)
